...
<div class="container mx-auto p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="image-gallery">
        <div class="main-image">
            <img id="mainImage" src="./includes/Kyiem/RFC10090 (1).jpg" alt="Main Image">
        </div>
        <div class="gallery">
            <img class="gallery-image" src="./includes/Kyiem/RFC10090.jpg" alt="Image 1" onclick="changeImage('./includes/Kyiem/RFC10090.jpg')">
            <img class="gallery-image" src="./includes/Kyiem/RFC10097.jpg" alt="Image 2" onclick="changeImage('./includes/Kyiem/RFC10097.jpg')">
            <img class="gallery-image" src="./includes/Kyiem/RFC10126.jpg" alt="Image 3" onclick="changeImage('./includes/Kyiem/RFC10126.jpg')">
            <img class="gallery-image" src="./includes/Kyiem/RFC10173 (1).jpg" alt="Image 4" onclick="changeImage('./includes/Kyiem/RFC10173 (1).jpg')">
        </div>

        <div class="form-container mt-4">
            <h2 class="text-3xl font-bold mb-4">KYIEM</h2>
            <p class="mb-4 text-justify">
Kyiem Traveller’s Nest Homestay, located in the peaceful village of Kyiem near Mawphlang, Meghalaya, offers travellers a unique blend of comfort and local culture. Situated 28 km south of Shillong, this charming retreat features five eco-friendly cottages.        </div>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      ...
      <div class="bg-white rounded-lg shadow p-4 hover:shadow-md transition">
        <h3 class="text-base font-semibold text-gray-800 mb-1">Waterfall Nearby</h3>
        <p class="text-sm text-gray-600">Two minitues walking distance</p>
      </div>
    </div>
  </div>
</section>
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    const email = form.querySelector('[name="email"]').value || "guest@example.com"; // Razorpay requires email
    ...
    const options = {
        ...
        handler: function (response) {
            // Proceed with form submit after payment success
